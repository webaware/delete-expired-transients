	...
	*/
	public function addPluginDetailsLinks($links, $file) {
		if ($file == DELXTRANS_PLUGIN_NAME) {
			...
			$links[] = sprintf('<a href="shop.webaware.com.au/donations/?donation_for=Delete+Expired+Transients">%s</a>', _x('Donate', 'plugin details links', 'delete-expired-transients'));
		}
